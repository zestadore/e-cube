				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							<h2 class="title-head text-uppercase">Terms & Conditions</h2>
						</div>
					</div>
                    ...
                    <p style="align:justify">
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://ecubecareers.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
                    </p>
                    <p style="align:justify">
                        The Platform is owned by 8590737624, a company incorporated under the Companies Act, 1956 with its registered office at UDHAYA BUILDING NELLAD PO MUVATTUPUZHA ERNAKULAM KERALA  (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..
                    </p>
                    <p style="align:justify">
