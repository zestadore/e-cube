                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">BackGroundQuestions</h4>
                            </div>
                            <div class="">
            ...
            <div class="modal-content">
                ...
                <form id="addForm">
                    ...
                    <div class="modal-body">
                        ...
                        <x-InputBox class="form-control {{ $errors->has('question') ? ' is-invalid' : '' }}" title="Question" name="question" id="question" type="text" required="True"/>
                    </div>
    ...
    <script>
        ...
        function drawTable()
        {
            var table = $('#item-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.background-question.index') }}",
                    data: function (d) {
        ...
        $('#addSaveButton').click(function(){
            ...
            $.ajax({
                url: "{{ route('admin.background-question.store') }}",
                type: "POST",
                data: formData,
        ...
        function editQualification(id){
            var url = "{{route('admin.background-question.edit',':id')}}";
        ...
        function deleteQualification(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{route('admin.background-question.destroy',':id')}}";
                    url = url.replace(':id', id);
                    $.ajax({
                        url: url,
                        type: "POST",
