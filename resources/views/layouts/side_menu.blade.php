        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @can('isEmployee')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('employee/payment-history'))? 'active' : '' }}" aria-current="page" href="{{ route('employee.payment-history') }}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M2 7C2 5.34315 3.34315 4 5 4H19C20.6569 4 22 5.34315 22 7V17C22 18.6569 20.6569 20 19 20H5C3.34315 20 2 18.6569 2 17V7Z" fill="currentColor"></path>
                                    <path d="M12 11C12.5523 11 13 11.4477 13 12V16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16V12C11 11.4477 11.4477 11 12 11Z" fill="currentColor"></path>
                ...
                @can('isEmployer')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('employer/jobs*') ? 'active' : '' }}" aria-current="page" href="{{ route('employer.jobs.index') }}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M21 7V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V7C3 4 4.5 2 8 2H16C19.5 2 21 4 21 7Z" fill="currentColor"></path>
                                    <path d="M17.5 12C17.5 11.1716 16.8284 10.5 16 10.5H8C7.17157 10.5 6.5 11.1716 6.5 12C6.5 12.8284 7.17157 13.5 8 13.5H16C16.8284 13.5 17.5 12.8284 17.5 12Z" fill="currentColor"></path>
                            ...
                            <span class="item-name">Job Posts</span>
                        </a>
                    </li>
                    <li class="nav-item">
